...
<head>
    ...
    <style>
        body {
            ...
            background-image: url("apps/pengaturan/logo/pusat.jpg"); /* Ganti path/to/your/image.jpg dengan path gambar Anda */
...
<body>
<div class="container rounded shadow-lg px-4 py-5 mt-5" style="max-width: 420px; background-color: rgba(255, 255, 255, 0.5);">
